# -*- coding: utf-8 -*-
#
# Unsynced Lyrics: a Quod Libet plugin for viewing lyrics.
...
"""Provides the `ViewUnsyncLyrics` plugin for viewing lyrics in the main window."""
...
class ViewUnsyncLyrics(EventPlugin):

    """The plugin for viewing lyrics in the main window."""

    PLUGIN_ID = 'Unsynced Lyrics'
    PLUGIN_NAME = _('Unsynced Lyrics')
